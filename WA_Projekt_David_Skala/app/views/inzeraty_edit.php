                ...
                <tbody>
                    <?php foreach ($inzeraty as $inzerat): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($inzerat['nazev_vozu']) ?></td>
                            <td><?= htmlspecialchars($inzerat['rok_vyroby']) ?></td>
                            <td><?= htmlspecialchars(number_format($inzerat['najeto'], 0, '', ' ')) ?> km</td>
                            <td><?= htmlspecialchars(number_format($inzerat['cena'], 0, '', ' ')) ?> Kč</td>
                            <td><?= htmlspecialchars($inzerat['kontakt']) ?></td>
                            <td>
                                <a href="edit_inzerat.php?id=<?= $inzerat['id_cislo'] ?>" class="btn btn-sm btn-primary">Upravit</a>
                                <a href="../controllers/delete_inzerat.php?id=<?= $inzerat['id_cislo'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Opravdu chcete smazat tento inzerát?');">Smazat</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
